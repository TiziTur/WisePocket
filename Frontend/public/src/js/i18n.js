...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      'dash.ocr.file.label':     'Imagen del ticket (JPG, PNG, WEBP, HEIC, AVIF, PDF…)',
      ...
      'dash.achv.title':              'Logros',
      'dash.achv.sub':                'Tus badges y progreso',
      'dash.achv.earned':             'conseguidos',
      'dash.achv.of':                 'de',
      'dash.achv.badges':             'badges',
      'dash.achv.earnedOn':           'Conseguido el',
      'dash.achv.locked':             'Bloqueado',
      'dash.achv.seeAll':             'Ver todos mis logros →',
      'dash.achv.nextBadge':          'Próximo badge',
      'dash.achv.progress':           'Progreso',
      ...
      'dash.sh.sub':                  'Amigos, gastos y balances',
      'dash.sh.friends.title':        'Mis amigos',
      'dash.sh.friends.addLabel':     'Añadir amigo por email',
      'dash.sh.friends.addBtn':       'Enviar solicitud',
      'dash.sh.friends.empty':        'Aún no tienes amigos en Klarity.',
      'dash.sh.friends.pending':      'Solicitudes recibidas',
      'dash.sh.friends.accept':       'Aceptar',
      'dash.sh.friends.reject':       'Rechazar',
      'dash.sh.friends.remove':       'Eliminar',
      'dash.sh.expenses.title':       'Gastos compartidos',
      'dash.sh.expenses.newBtn':      'Crear gasto',
      'dash.sh.expenses.empty':       'No hay gastos compartidos.',
      'dash.sh.expenses.concept':     'Concepto',
      'dash.sh.expenses.amount':      'Importe',
      'dash.sh.expenses.date':        'Fecha',
      'dash.sh.expenses.status':      'Estado',
      'dash.sh.expenses.create':      'Crear gasto compartido',
      'dash.sh.expenses.addPart':     'Añadir participante',
      'dash.sh.expenses.saveBtn':     'Guardar',
      'dash.sh.expenses.cancelBtn':   'Cancelar',
      'dash.sh.expenses.settled':     'Saldado',
      'dash.sh.expenses.pending':     'Pendiente',
      'dash.sh.balance.title':        'Balance',
      'dash.sh.balance.owedTo':       'Me deben',
      'dash.sh.balance.iOwe':         'Debo',
      'dash.sh.balance.empty':        'No hay deudas pendientes.',
      'dash.sh.balance.settle':       'Marcar saldado',
      'dash.js.friendSent':           'Solicitud enviada.',
      'dash.js.friendAccepted':       'Solicitud aceptada.',
      'dash.js.friendRejected':       'Solicitud rechazada.',
      'dash.js.friendRemoved':        'Amigo eliminado.',
      'dash.js.sharedSaved':          'Gasto compartido creado.',
      'dash.js.settled':              'Deuda marcada como saldada.',
    ...
    en: {
      ...
      'dash.ocr.file.label':     'Receipt image (JPG, PNG, WEBP, HEIC, AVIF, PDF…)',
      ...
      // Dashboard — achievements section
      'dash.achv.title':              'Achievements',
      'dash.achv.sub':                'Your badges and progress',
      'dash.achv.earned':             'earned',
      'dash.achv.of':                 'of',
      'dash.achv.badges':             'badges',
      'dash.achv.earnedOn':           'Earned on',
      'dash.achv.locked':             'Locked',
      'dash.achv.seeAll':             'See all my achievements →',
      'dash.achv.nextBadge':          'Next badge',
      'dash.achv.progress':           'Progress',
      ...
      'dash.sh.sub':                  'Friends, expenses and balances',
      'dash.sh.friends.title':        'My friends',
      'dash.sh.friends.addLabel':     'Add a friend by email',
      'dash.sh.friends.addBtn':       'Send request',
      'dash.sh.friends.empty':        'You have no friends on Klarity yet.',
      'dash.sh.friends.pending':      'Pending requests',
      'dash.sh.friends.accept':       'Accept',
      'dash.sh.friends.reject':       'Reject',
      'dash.sh.friends.remove':       'Remove',
      'dash.sh.expenses.title':       'Shared expenses',
      'dash.sh.expenses.newBtn':      'Create expense',
      'dash.sh.expenses.empty':       'No shared expenses yet.',
      'dash.sh.expenses.concept':     'Description',
      'dash.sh.expenses.amount':      'Amount',
      'dash.sh.expenses.date':        'Date',
      'dash.sh.expenses.status':      'Status',
      'dash.sh.expenses.create':      'Create shared expense',
      'dash.sh.expenses.addPart':     'Add participant',
      'dash.sh.expenses.saveBtn':     'Save',
      'dash.sh.expenses.cancelBtn':   'Cancel',
      'dash.sh.expenses.settled':     'Settled',
      'dash.sh.expenses.pending':     'Pending',
      'dash.sh.balance.title':        'Balance',
      'dash.sh.balance.owedTo':       'Owed to me',
      'dash.sh.balance.iOwe':         'I owe',
      'dash.sh.balance.empty':        'No outstanding debts.',
      'dash.sh.balance.settle':       'Mark as settled',
      'dash.js.friendSent':           'Request sent.',
      'dash.js.friendAccepted':       'Request accepted.',
      'dash.js.friendRejected':       'Request rejected.',
      'dash.js.friendRemoved':        'Friend removed.',
      'dash.js.sharedSaved':          'Shared expense created.',
      'dash.js.settled':              'Debt marked as settled.',
